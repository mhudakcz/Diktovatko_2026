...
STRINGS = {
    "cs": {
        ...
        "notify.update.body": "Je k dispozici verze {v}. Co se mění, uvidíte po kliknutí na ikonu → Aktualizovat.",
        "notify.update.many": "Je k dispozici verze {v}. Od vaší verze {cur} vyšlo nových verzí: {n}. Co se mění, uvidíte po kliknutí na ikonu → Aktualizovat.",
    ...
    "en": {
        ...
        "notify.update.body": "Version {v} is available. Click the icon → Update to see what changes.",
        "notify.update.many": "Version {v} is available. New versions since your {cur}: {n}. Click the icon → Update to see what changes.",
    ...
    "de": {
        ...
        "notify.update.body": "Version {v} ist verfügbar. Was sich ändert, sehen Sie nach Klick auf das Symbol → Aktualisieren.",
        "notify.update.many": "Version {v} ist verfügbar. Neue Versionen seit Ihrer {cur}: {n}. Was sich ändert, sehen Sie nach Klick auf das Symbol → Aktualisieren.",
