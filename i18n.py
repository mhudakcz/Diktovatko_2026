...
STRINGS = {
    "cs": {
        ...
        "notify.updated": "Diktovátko je aktualizované na verzi {v}.",
        "update.ask.title": "Aktualizace Diktovátka",
        "update.ask.text": "Je k dispozici verze {v} (máte {cur}).\n\nCo je nového:\n\n{notes}\n\nAktualizovat teď? Nastavení, klíč i historie zůstanou.",
        "update.ask.yes": "Aktualizovat",
        "update.ask.later": "Později",
        "update.more": "… a další, viz {url}",
        "update.rollback.title": "Aktualizace se nepovedla",
        "update.rollback.text": "Nová verze {v} se nespustila, proto se Diktovátko vrátilo na verzi {cur}. Nic se neztratilo. Podrobnosti jsou v souboru update.log ve složce Diktovátka.",
        "menu.quit": "Ukončit",
    ...
    "en": {
        ...
        "notify.updated": "Diktovátko has been updated to version {v}.",
        "update.ask.title": "Diktovátko update",
        "update.ask.text": "Version {v} is available (you have {cur}).\n\nWhat's new:\n\n{notes}\n\nUpdate now? Your settings, key and history stay.",
        "update.ask.yes": "Update",
        "update.ask.later": "Later",
        "update.more": "… and more, see {url}",
        "update.rollback.title": "The update failed",
        "update.rollback.text": "The new version {v} did not start, so Diktovátko went back to version {cur}. Nothing was lost. Details are in update.log in the Diktovátko folder.",
        "menu.quit": "Quit",
    ...
    "de": {
        ...
        "notify.updated": "Diktovátko wurde auf Version {v} aktualisiert.",
        "update.ask.title": "Diktovátko-Aktualisierung",
        "update.ask.text": "Version {v} ist verfügbar (Sie haben {cur}).\n\nNeuigkeiten:\n\n{notes}\n\nJetzt aktualisieren? Einstellungen, Schlüssel und Verlauf bleiben erhalten.",
        "update.ask.yes": "Aktualisieren",
        "update.ask.later": "Später",
        "update.more": "… und mehr, siehe {url}",
        "update.rollback.title": "Die Aktualisierung ist fehlgeschlagen",
        "update.rollback.text": "Die neue Version {v} startete nicht, daher ist Diktovátko zu Version {cur} zurückgekehrt. Nichts ging verloren. Details stehen in update.log im Diktovátko-Ordner.",
        "menu.quit": "Beenden",
